...
#
# Assumptions:
# - This file sits next to newserver.py (so `import newserver` works).
# - Your environment already runs newserver.py successfully (so its imports/deps exist).
...
import newserver as ns  # uses your existing segmenter code
